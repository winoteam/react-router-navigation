...
import { AppRegistry, StyleSheet, TouchableWithoutFeedback, Platform, View, Text } from 'react-native';
...
const IndexScene = (props, context) => (
  <View style={styles.scene}>
    <Text>Index</Text>
    <TouchableWithoutFeedback onPress={() => context.history.push('hello/two')}>
      <View>
        <Text>Push</Text>
      </View>
